...
local defaultShakeMagnitude = 5
local defaultShakeDuration = 1
...
function Camera:new()
    ...
    self.shakeTime = defaultShakeDuration
    self.shakeMagnitude = defaultShakeMagnitude
    self.shakeDuration = defaultShakeDuration
end

function Camera:update(dt)
    if self.shakeTime < defaultShakeDuration then
...
function Camera:drawScreen(func)
    love.graphics.push()
...
function Camera:shake(duration, magnitude)
    self.shakeTime = 0
    self.shakeDuration = duration or defaultShakeDuration
    self.shakeMagnitude = magnitude or defaultShakeMagnitude
end
